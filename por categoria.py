...
# Función para evaluar el modelo y calcular precisión por categoría
def evaluate_model(perceptron, X_test, Y_test):
    ...
    return confusion_matrix, class_precisions, overall_accuracy
...
confusion_matrix, class_precisions, overall_accuracy = evaluate_model(perceptron, X_test, Y_test)

# Imprimir resultados
print("Matriz de Confusión:")
print(confusion_matrix)
print("\nPrecisión por categoría de movimiento:")
print(f"Lineal: {class_precisions[0]:.2f}%")
print(f"Circular: {class_precisions[1]:.2f}%")
print(f"Aleatorio: {class_precisions[2]:.2f}%")
